  ...
  <div class="wrapper">
    <div class="container-massive">
      ...
      <div class="instructions">
        ...
        <hr />
        <ul>
          <li>El nombre debe ir en su respectiva celda.</li>
          <li>El id debe ser único.</li>
          <li>
        ...
        <form @submit.prevent="onSubmit">
          <div class="input-button">
            ...
            <div class="button-align back-button">
              <button
                type="button"
                @click="$router.push({ name: 'register-destination' })"
...
export default {
  setup() {
    ...
    const { excelTemplateDestinations } = createFiles();
    ...
    return {
      ...
      onDownload: async () => {
        ...
        const { ok } = excelTemplateDestinations();
